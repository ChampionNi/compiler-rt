...
int test__aeabi_cfcmple(float a, float b)
{
...
{
#if __arm__
    if (test__aeabi_cfcmple(1.0, 1.0))
        return 1;
    if (test__aeabi_cfcmple(1234.567, 765.4321))
        return 1;
    if (test__aeabi_cfcmple(765.4321, 1234.567))
        return 1;
    if (test__aeabi_cfcmple(-123.0, -678.0))
        return 1;
    if (test__aeabi_cfcmple(-678.0, -123.0))
        return 1;
    if (test__aeabi_cfcmple(0.0, -0.0))
        return 1;
    if (test__aeabi_cfcmple(1.0, NAN))
        return 1;
    if (test__aeabi_cfcmple(NAN, 1.0))
        return 1;
#else
    printf("skipped\n");
#endif
