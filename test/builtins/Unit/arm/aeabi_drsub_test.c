...
int test__aeabi_drsub(double a, double b)
{
...
{
#if __arm__
    if (test__aeabi_drsub(1.0, 1.0))
        return 1;
    if (test__aeabi_drsub(1234.567, 765.4321))
        return 1;
    if (test__aeabi_drsub(-123.0, -678.0))
        return 1;
    if (test__aeabi_drsub(0.0, -0.0))
        return 1;
#else
    printf("skipped\n");
#endif
