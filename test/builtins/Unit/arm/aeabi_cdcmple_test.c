...
int test__aeabi_cdcmple(double a, double b)
{
...
{
#if __arm__
    if (test__aeabi_cdcmple(1.0, 1.0))
        return 1;
    if (test__aeabi_cdcmple(1234.567, 765.4321))
        return 1;
    if (test__aeabi_cdcmple(765.4321, 1234.567))
        return 1;
    if (test__aeabi_cdcmple(-123.0, -678.0))
        return 1;
    if (test__aeabi_cdcmple(-678.0, -123.0))
        return 1;
    if (test__aeabi_cdcmple(0.0, -0.0))
        return 1;
    if (test__aeabi_cdcmple(1.0, NAN))
        return 1;
    if (test__aeabi_cdcmple(NAN, 1.0))
        return 1;
#else
    printf("skipped\n");
#endif
