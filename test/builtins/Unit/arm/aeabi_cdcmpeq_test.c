...
int test__aeabi_cdcmpeq(double a, double b)
{
...
{
#if __arm__
    if (test__aeabi_cdcmpeq(1.0, 1.0))
        return 1;
    if (test__aeabi_cdcmpeq(1234.567, 765.4321))
        return 1;
    if (test__aeabi_cdcmpeq(-123.0, -678.0))
        return 1;
    if (test__aeabi_cdcmpeq(0.0, -0.0))
        return 1;
    if (test__aeabi_cdcmpeq(1.0, NAN))
        return 1;
    if (test__aeabi_cdcmpeq(NAN, 1.0))
        return 1;
#else
    printf("skipped\n");
#endif
