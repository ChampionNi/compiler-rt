...
int test__aeabi_frsub(float a, float b)
{
...
{
#if __arm__
    if (test__aeabi_frsub(1.0, 1.0))
        return 1;
    if (test__aeabi_frsub(1234.567, 765.4321))
        return 1;
    if (test__aeabi_frsub(-123.0, -678.0))
        return 1;
    if (test__aeabi_frsub(0.0, -0.0))
        return 1;
#else
    printf("skipped\n");
#endif
