...
# installed on /data). That's because /data may not be available until vold does some magic (seen
# in aosp_shamu configuration), and vold itself depends on this library.
